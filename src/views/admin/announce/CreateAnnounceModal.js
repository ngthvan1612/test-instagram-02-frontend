...
function CreateAnnounceModal(props) {
  ...
  const handleCreateAnnounce = () => {
    ...
    AdminAnnounceApi.createAnnounce(announce).then(resp => {
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Create announce</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleCreateAnnounce}>
            Create
          </Button>
        </Modal.Footer>
      </Modal>
